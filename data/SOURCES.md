...
本站点内容编写时参考以下公开来源，按类型分类。`validate-content.mjs` 中的 `sources` 字段应引用此清单中的键名。

## 史诗原文与结构

| 键名 | 说明 |
|------|------|
| `homer_odyssey` | 荷马《奥德赛》全书 |
| `homer_odyssey_book1` … `homer_odyssey_book24` | 各卷情节概要（基于史诗结构） |
| `homer_iliad` | 《伊利亚特》与史诗接续关系 |
| `hesiod_theogony` | 赫西俄德《神谱》 |

## 学术与百科

| 键名 | 说明 |
|------|------|
| `wikipedia_odyssey` | 维基百科：奥德赛 |
| `wikipedia_odysseus` | 维基百科：奥德修斯 |
| `wikipedia_greek_mythology` | 维基百科：希腊神话 |
| `wikipedia_trojan_war` | 维基百科：特洛伊战争 |
| `wikipedia_mycenae` | 维基百科：迈锡尼文明 |
| `wikipedia_homer` | 维基百科：荷马 |
| `oral_formulaic_theory` | 口头程式理论（帕里-洛德） |
